        ...
        <div class="parent-div">
          ...
          >
            ...
            <div style="margin: 0 15px">
              ...
              <p style="font-size:12px">{{ `${document.description.slice(1, 20)}...` }}</p>
            </div>
            <v-spacer></v-spacer>
            <div></div>
            <v-spacer />
...
export default {
  ...
  computed: {
    ...mapGetters({
      documents: "sent_document/getDocuments",
      user: "login/getUserData",
      getCurrentPage: "sent_document/getCurrentPage",
    }),
  },
  created() {
  ...
  methods: {
    searchDocument: debounce(async function () {
      try {
        await this.$store.dispatch("sent_document/fetchDocuments", {
